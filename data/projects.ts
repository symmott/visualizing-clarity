    ...
    chapters: [
      {
        ...
        perspective: "콘텐츠의 중요도에 따라 시각적 위계를 설정하고, 헤드라인–비주얼–본문 간의 흐름이 명확히 읽히도록 설계했습니다.",
        deliverables: ["실물 매거진 지면 디자인", "콘텐츠 카테고리 구조 다이어그램", "지면 레이아웃 가이드"],
        outcome: ["독자 피드백에서 구성이 명확하다는 평가 확보", "학과 내부 이벤트 홍보 콘텐츠 게재 요청"]
      },
      {
        title: "Chapter B. SNS & Digital",
        subtitle: "Data-driven Content Optimization",
        perspective: "Instagram Insights 데이터를 활용해 성과가 높은 콘텐츠의 공통 요소를 도출하여 구조화했습니다.",
        deliverables: ["SNS 콘텐츠 디자인", "데이터 정리 시트", "콘텐츠 구조 개선 전·후 비교 자료"],
